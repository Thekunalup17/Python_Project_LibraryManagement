...
def bookRegister():
    ...
    insertBooks = "insert into "+bookTable+" values('"+bid+"','"+title+"','"+author+"','"+status+"','"+issuedto+"')"
    try:
...
def addBook(): 
    ...
    global bookInfo1,bookInfo2,bookInfo3,bookInfo4,bookInfo5,Canvas1,con,cur,bookTable,root,issuedto
    ...
    # issued To
    lb5 = Label(labelFrame,text="Issued To : ", bg='black', fg='white')
