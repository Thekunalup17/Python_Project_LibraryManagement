...
def returnn():
    ...
    global SubmitBtn,labelFrame,lb1,bookInfo1,quitBtn,root,Canvas1,status,issuedto
    ...
    print(bid in allBid)
    print(status)
    updateStatus = "update "+bookTable+" set status = 'avail' , issuedto = 'None' where bid = '"+bid+"'"
    try:
